#!/usr/bin/env python3
"""GLM-CN 200+ case E2E suite with real credentials and detailed report."""
...
SECONDARY_MODEL = "algae/glm-cn/glm-4-think"
...
def write_report() -> Path:
    report_path = Path("glm_cn_200_cases_report.md")
    total = len(results)
    ...
    lines = []
    lines.append("# GLM-CN 200+ Case E2E Report")
    lines.append("")
